...
use App\Domains\Task\Infra\Gateways\HubClient;
use App\Domains\Task\Infra\Gateways\MarketingPlaceClient;
use App\Domains\Task\Infra\Listeners\OnFetchedOfferDetail;
use App\Domains\Task\Infra\Listeners\OnFetchedOffersReferencesFromPage;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Event::listen(FetchedOffersReferencesFromPageEvent::class, OnFetchedOffersReferencesFromPage::class);
        Event::listen(FetchedOfferDetailEvent::class, OnFetchedOfferDetail::class);
    }
}
